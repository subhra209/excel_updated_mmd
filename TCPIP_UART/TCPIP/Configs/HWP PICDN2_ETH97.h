...
// Hardware I/O pin mappings SAM - 30-MAR-2012
// LEDs
//#define LED0_TRIS			(TRISEbits.TRISE0)	// Ref D8
//#define LED0_IO				(LATEbits.LATE0)
#define LED0_TRIS			(TRISCbits.TRISC0)	// Ref D8
#define LED0_IO				(LATCbits.LATC0)

#define LED1_TRIS			(TRISEbits.TRISE1)	// Ref D7
#define LED1_IO				(LATEbits.LATE1)
#define LED2_TRIS			(TRISEbits.TRISE2)	// Ref D6
#define LED2_IO				(LATEbits.LATE2)
#define LED3_TRIS			(TRISEbits.TRISE3)	// Ref D5
#define LED3_IO				(LATEbits.LATE3)
#define LED4_TRIS			(TRISEbits.TRISE4)	// Ref D4
#define LED4_IO				(LATEbits.LATE4)
#define LED5_TRIS			(TRISEbits.TRISE5)	// Ref D3
#define LED5_IO				(LATEbits.LATE5)
#define LED6_TRIS			(TRISDbits.TRISD6)	// Ref D2
#define LED6_IO				(LATDbits.LATD6)
#define LED7_TRIS			(TRISDbits.TRISD7)	// Ref D1
...
// 25LC256 I/O pins  SAM 30-Mar-2012
