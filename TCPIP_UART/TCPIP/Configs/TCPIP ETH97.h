...
#define MY_DEFAULT_IP_ADDR_BYTE3       (1ul)// (253ul)
#define MY_DEFAULT_IP_ADDR_BYTE4       (200ul)// (176ul)
 ...
 */
	...
	#define END_OF_TCP_SOCKET_TYPES
		...
		ROM struct
		{
			BYTE vSocketPurpose;
			BYTE vMemoryMedium;
			WORD wTXBufferSize;//unsigned long wTXBufferSize;//
			WORD wRXBufferSize;//unsigned long wRXBufferSize; //
...
//			{TCP_PURPOSE_HTTP_SERVER, TCP_ETH_RAM, 200, 200},
			...
			{TCP_PURPOSE_BERKELEY_SERVER, TCP_ETH_RAM, 35, 35},
			{TCP_PURPOSE_BERKELEY_SERVER, TCP_ETH_RAM, 35, 35},
			{TCP_PURPOSE_BERKELEY_SERVER, TCP_ETH_RAM, 35, 35},
			{TCP_PURPOSE_BERKELEY_SERVER, TCP_ETH_RAM, 35, 35},
			{TCP_PURPOSE_BERKELEY_SERVER, TCP_ETH_RAM, 35, 35},
			...
			{TCP_PURPOSE_BERKELEY_SERVER, TCP_ETH_RAM, 35, 35},
			{TCP_PURPOSE_BERKELEY_SERVER, TCP_ETH_RAM, 35, 35},
			{TCP_PURPOSE_BERKELEY_SERVER, TCP_ETH_RAM, 35, 20},
